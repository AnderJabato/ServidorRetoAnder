...
const { obtenerInformacion } = require('../controladores/incidenciaControlador');
const { obtenerUsuarios } = require('../controladores/usuariosControlador');

// Peticiones GET
//router.get('/usuario', obtenerUsuario);//obtienen usuario creado
router.get('/incidencias', obtenerInformacion);//obtiene las 20 incidencias mas recientes de la base de datos
